...
export default function HamburgerToggle() {
  return (
    <motion.div
      ...
      className="fixed top-0 -right-6 z-50 w-40 h-full flex  justify-center items-center bg-gradient-to-tr from-[#100c1a] to-transparent  backdrop-blur-sm shadow-xl rounded-xl "
    >
